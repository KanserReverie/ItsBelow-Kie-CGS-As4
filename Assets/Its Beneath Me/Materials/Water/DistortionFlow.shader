Shader "Custom/DistortionFlow"
{
    Properties
    {
        ...
        // This will bring in our flow map.
        ...
        // Changes the flow offset of when it starts.
    ...
    SubShader
    {
        ...
        float2 AlignWitherGrabTexel(float2 uv)
        {
        ...
        float3 ColorBelowWater(float4 screenPos, float3 tangentSpaceNormal)
        {
            ...
            float2 uv = AlignWitherGrabTexel((screenPos.xy + uvOffset) / screenPos.w);
            ...
            uv = AlignWitherGrabTexel((screenPos.xy + uvOffset) / screenPos.w);
